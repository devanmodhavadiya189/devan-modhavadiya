...
export default function Contact() {
  ...
  const phone = import.meta.env.VITE_PHONE || '+1234567890'
  ...
  return (
    <section id="contact" className="section scroll-section" ref={sectionRef}>
        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <div className="social-links">
              <a href={github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social-github">
              ...
              <a href={linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-linkedin">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
